...
const handleSubmit = async (
  ...
  // Persistent Session Management Logic
  ...
  // Auto-Scroll message stream box viewports
  useEffect(() => {
  ...
  // API Message Dispatch Loop
  const handleSend = async (e: React.FormEvent) => {
    e.preventDefault();
    const trimmedMessage = inputMessage.trim();
    if (!trimmedMessage) return;

    // Append User message node instantly
  ...
  {
    quote:
      "Working with SGR Dynamics was straightforward and professional. They delivered exactly what we needed and were responsive throughout the project.",
    name: "Rahul K.",
    avatar: "bg-primary-container",
  },
  {
    quote:
      "The team helped us modernize our website and improve the overall user experience. The final product was clean, fast, and easy to manage.",
    name: "Priya S.",
    avatar: "bg-secondary-container",
  },
  {
    quote:
      "Their automation solution reduced a lot of manual work for our team. The implementation was smooth and the results were noticeable within weeks.",
    name: "Vikram R.",
    avatar: "bg-tertiary-container",
  },
  {
    quote:
      "Communication was clear from start to finish. They understood our requirements quickly and delivered the project on schedule.",
    name: "Anjali M.",
    avatar: "bg-primary-container",
  },
  {
    quote:
      "We appreciated their attention to detail and problem-solving approach. The software they built has become an important part of our daily operations.",
    name: "Karthik P.",
    avatar: "bg-secondary-container",
  },
  ];
    ...
    faqs: [
      {
        ...
        a: "We develop business websites, landing pages, SaaS platforms, customer portals, dashboards, and custom web applications tailored to business requirements.",
      },
      {
        q: "How long does a website project take?",
        a: "Timelines depend on complexity. Simple websites may take a few weeks, while larger platforms and software solutions require additional development time.",
      },
      {
        q: "Will my website work on mobile devices?",
        a: "Yes. Every website is fully responsive and optimized for desktops, tablets, and smartphones.",
      },
      {
        q: "Can you redesign my existing website?",
        a: "Absolutely. We can modernize outdated websites, improve performance, and enhance the overall user experience.",
      },
      {
        q: "Will I be able to manage content myself?",
        a: "Yes. We can provide content management functionality so you can update content without technical knowledge.",
      },
      {
        q: "Do you provide support after launch?",
        a: "Yes. We offer maintenance, updates, monitoring, and technical support after deployment.",
      },
    ],
  },
    ...
    faqs: [
      {
        ...
        a: "Yes. We build cross-platform mobile applications that work seamlessly across Android and iOS devices.",
      },
      {
        q: "What types of mobile apps can you build?",
        a: "We develop business apps, educational apps, booking platforms, fitness applications, e-commerce apps, and more.",
      },
      {
        q: "Can mobile apps connect with my website?",
        a: "Yes. Mobile applications can integrate with websites, APIs, databases, payment gateways, and third-party systems.",
      },
      {
        q: "Will the app be published to app stores?",
        a: "Yes. We assist with publishing applications to Google Play Store and Apple App Store.",
      },
      {
        q: "How secure are mobile applications?",
        a: "We implement secure authentication, encryption, data protection, and industry best practices.",
      },
      {
        q: "Can existing apps be upgraded?",
        a: "Yes. We can redesign, optimize, and expand existing mobile applications with new features.",
      },
    ],
  },
    ...
    faqs: [
      {
        ...
        a: "Business automation uses software to eliminate repetitive manual tasks and improve operational efficiency.",
      },
      {
        q: "How can AI help my business?",
        a: "AI can automate customer support, lead management, reporting, content generation, and many operational processes.",
      },
      {
        q: "Do I need technical knowledge to use AI systems?",
        a: "No. We build solutions that are simple to use and accessible for non-technical teams.",
      },
      {
        q: "Can AI integrate with my existing tools?",
        a: "Yes. AI solutions can connect with CRMs, websites, databases, communication platforms, and business software.",
      },
      {
        q: "Is my business data secure?",
        a: "Yes. Security and privacy are incorporated into every solution using industry-standard best practices.",
      },
      {
        q: "What processes can be automated?",
        a: "Lead management, reporting, notifications, scheduling, customer communication, approvals, and many repetitive workflows.",
      },
    ],
  },
];
const contactMethods = [
  {
    ...
    // color: "bg-peach-glow/20 text-primary",
  },
  {
    ...
    // color: "bg-coral-vibrant/20 text-secondary",
  },
  {
    ...
    // color: "bg-primary/20 text-primary dark:text-peach-glow",
  },
];
  const navLinks = [
  ...
  return (
    <div className="bg-surface text-on-surface dark:bg-slate-deep dark:text-[#f5f0ed] transition-colors duration-500 overflow-x-hidden">
      ...
      {/* Nav */}
      <nav className="fixed top-4 left-1/2 -translate-x-1/2 w-[95%] max-w-container-max rounded-full border border-white/10 bg-surface/80 dark:bg-slate-deep/80 backdrop-blur-xl flex justify-between items-center px-8 py-3 z-50 shadow-[0_8px_32px_rgba(99,68,50,0.08)]">
    ...
    <span className="text-sm uppercase tracking-[0.2em] text-on-surface-variant">
      Digital Innovation
        ...
        <section id="projects" className="py-32 px-margin-desktop max-w-container-max mx-auto">
          <h2 className="font-label-md text-label-md text-coral-vibrant uppercase tracking-widest mb-12">04 / FEATURED BLUEPRINTS</h2>
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
            <div className="md:col-span-8 glass-card rounded-3xl overflow-hidden group">
              <div className="relative h-96 overflow-hidden">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-umber-rich/80 via-transparent to-transparent" />
                <div className="absolute bottom-8 left-8">
                  <h4 className="font-headline-lg text-headline-lg text-white mb-2">Apex Fitness</h4>
                  <div className="flex gap-2">
                    <span className="px-3 py-1 bg-peach-glow text-umber-rich font-caption text-caption rounded-full">99 PageSpeed</span>
                    <span className="px-3 py-1 bg-white/20 backdrop-blur-sm text-white font-caption text-caption rounded-full">React Native</span>
                  </div>
                </div>
              </div>
            </div>
            <div className="md:col-span-4 glass-card rounded-3xl p-8 flex flex-col justify-center border-coral-vibrant/10">
              <h4 className="font-title-md text-title-md mb-4">LeadStream Automation</h4>
              <p className="font-body-md text-body-md text-on-surface-variant mb-6">
                Autonomous CRM synchronization with AI lead scoring using n8n.
              </p>
              <div className="flex gap-2 flex-wrap">
                <span className="px-3 py-1 bg-coral-vibrant/10 text-coral-vibrant font-caption text-caption rounded-full">n8n</span>
                <span className="px-3 py-1 bg-primary/10 text-primary dark:text-peach-glow font-caption text-caption rounded-full">Groq</span>
                <span className="px-3 py-1 bg-tertiary/10 text-tertiary font-caption text-caption rounded-full">Llama 3.3</span>
              </div>
            </div>
            <div className="md:col-span-4 glass-card rounded-3xl p-8 flex flex-col justify-center">
              <h4 className="font-title-md text-title-md mb-4">Nimbus SaaS Platform</h4>
              <p className="font-body-md text-body-md text-on-surface-variant mb-6">
                Multi-tenant Next.js SaaS with edge-cached dashboards and Stripe billing.
              </p>
              <div className="flex gap-2 flex-wrap">
                <span className="px-3 py-1 bg-primary/10 text-primary dark:text-peach-glow font-caption text-caption rounded-full">Next.js</span>
                <span className="px-3 py-1 bg-coral-vibrant/10 text-coral-vibrant font-caption text-caption rounded-full">Edge</span>
              </div>
            </div>
            <div className="md:col-span-8 glass-card rounded-3xl overflow-hidden group">
              <div className="relative h-64 overflow-hidden">
                <img
                  alt="FlowSync Automation"
                  className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"
                  src="/images/Fourth_project.png"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-umber-rich/70 to-transparent" />
                <div className="absolute bottom-6 left-8">
                  <h4 className="font-headline-lg text-headline-lg text-white">FlowSync Automation</h4>
                  <p className="text-white/80 font-body-md text-body-md">Intelligent workflow automation that connects business systems, streamlines operations, and eliminates repetitive tasks.</p>
                </div>
              </div>
            </div>
          </div>
  ...
  <div className="flex gap-8 animate-marquee w-max">
    {[...reviews, ...reviews].map((r, index) => (
      ...
      >
        ...
        <div className="flex items-center gap-4">
          <div
            className={`w-12 h-12 rounded-full ${r.avatar}`}
          />
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
    ...
    <div className="glass-card p-10 rounded-3xl group hover:scale-[1.02] transition-all">
      <span className="text-coral-vibrant text-5xl font-bold opacity-30">
        01
      </span>

      <h4 className="font-display-lg text-headline-md mt-4 mb-4">
        Discovery & Strategy
      </h4>

      <p className="text-on-surface-variant leading-relaxed mb-8">
        We begin by understanding your business, objectives, users, and
        challenges to identify the most effective digital solution.
      </p>

      <a
        href="#contact"
        className="inline-flex items-center gap-2 text-primary font-semibold hover:text-coral-vibrant transition-colors"
      >
        Start Discussion →
      </a>
    </div>
    ...
    <div className="glass-card p-10 rounded-3xl border-coral-vibrant/30 relative overflow-hidden shadow-xl">
      <div className="absolute top-0 right-0 px-5 py-2 bg-coral-vibrant text-white text-xs uppercase tracking-widest rounded-bl-xl">
        Most Common
      </div>
      ...
      <p className="text-on-surface-variant leading-relaxed mb-8">
        From concept to deployment, we build scalable web, mobile, software,
        and automation systems designed for performance and growth.
      </p>

      <a
        href="#contact"
        className="inline-flex items-center gap-2 text-coral-vibrant font-semibold"
      >
    ...
    <div className="glass-card p-10 rounded-3xl group hover:scale-[1.02] transition-all">
      ...
      <p className="text-on-surface-variant leading-relaxed mb-8">
        After launch, we continue optimizing, improving, and supporting your
        solution to ensure long-term success and measurable business impact.
      </p>
  ...
  <div className="mt-20 text-center">
    <h4 className="font-display-lg text-headline-md mb-4">
      Ready to discuss your next project?
    </h4>

    <p className="text-on-surface-variant mb-8 max-w-2xl mx-auto">
      Tell us about your idea, challenge, or business goal. We'll help you
      determine the best path forward.
    </p>

    <a
      href="#contact"
      className="inline-flex items-center justify-center px-10 py-4 rounded-xl bg-gradient-to-r from-peach-glow to-coral-vibrant text-white font-bold shadow-lg hover:scale-105 transition-all"
    >
      Get a Custom Proposal
        ...
        <section
  id="faq"
  className="py-32 bg-surface-container-low dark:bg-slate-deep/30 transition-colors"
>
  <div className="px-margin-desktop max-w-container-max mx-auto">
    <div className="flex flex-col md:flex-row gap-16">
      
      <div className="w-full md:w-1/3">
        <h2 className="font-label-md text-label-md text-coral-vibrant uppercase tracking-widest mb-6">
          06 / KNOWLEDGE BASE
        </h2>
        ...
        <p className="mt-6 text-on-surface-variant">
          Explore answers related to web development, mobile applications,
      ...
      <div className="w-full md:w-2/3 space-y-5">
        {faqCategories.map((category, categoryIndex) => {
          ...
          return (
            <div
              key={category.title}
              className="glass-card rounded-3xl overflow-hidden border border-outline-variant/30"
            >
              <button
                onClick={() =>
                  setOpenCategory(
                ...
                <div className="px-6 pb-6 space-y-3">
                  {category.faqs.map((faq, faqIndex) => {
                    ...
                    return (
                      <div
                        key={faq.q}
                        className="rounded-2xl bg-surface/40 border border-outline-variant/20"
                      >
                        <button
                          onClick={() =>
                            setOpenFaq(
...
>
  <div className="flex flex-col lg:flex-row gap-16">
    ...
    <div className="w-full lg:w-5/12">
      <h2 className="font-label-md text-label-md text-coral-vibrant uppercase tracking-widest mb-6">
        07 / SYSTEM ENGAGEMENT
      </h2>

      <h3 className="font-headline-lg text-headline-lg text-on-surface dark:text-[#f5f0ed] mb-6">
        Ready to evolve your digital presence?
      </h3>

      <p className="text-on-surface-variant mb-10 leading-relaxed">
        Whether you're planning a new website, mobile application,
        AI-powered automation, or a complete digital transformation,
        we're ready to discuss your vision.
      </p>
    ...
    <div className="w-full lg:w-7/12">
      ...
      <form
        ...
        className="glass-card p-10 rounded-3xl shadow-2xl border border-white/10"
      >
  ...
  <span className="font-headline-lg text-headline-lg text-primary dark:text-peach-glow block mb-4">
    SGR Dynamics
  </span>

  <p className="font-body-md text-body-md text-on-surface-variant dark:text-surface-variant mb-8 leading-relaxed">
    We help businesses build modern websites,
    mobile applications, AI solutions, and workflow
    automation systems that drive real growth.
  </p>
  ...
  <div className="flex gap-3">
    ...
    <a
      href="#"
      className="w-11 h-11 rounded-full glass-card flex items-center justify-center hover:text-coral-vibrant transition-all"
    >
  ...
  <div key={col.title}>
    <h5 className="font-label-md text-label-md text-primary dark:text-peach-glow uppercase mb-6 tracking-wider">
      {col.title}
    </h5>
    ...
    <ul className="space-y-4 font-body-md text-body-md text-on-surface-variant dark:text-surface-variant">
      {col.links.map((link) => (
        <li key={link}>
          <a
            href="#"
            className="hover:text-coral-vibrant transition-colors duration-300 flex items-center gap-2 group"
          >
  ...
  <span>
    © 2026 SGR Dynamics. All rights reserved.
  </span>
